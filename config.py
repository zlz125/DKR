...
def parseing_posttrain():
    ...
    parser.add_argument('--finetune_class_num', type=int)
    ...
    parser.add_argument("--eps", type=float, default=1e-3, help="optimizer eps to use.")
    ...
    parser.add_argument("--saved_curr_output_dir", type=str, default='./ckpt', help="Where to store the final model.")
    parser.add_argument("--saved_output_dir", type=str, default='./ckpt', help="Where to store the final model.")
    parser.add_argument("--seed", type=int, default=2021, help="A seed for reproducible training.")
    parser.add_argument(
        "--model_type",
        type=str,
        default=None,
    ...
    parser.add_argument("--base_dir", default='/home/zlz/codes/LLMs/ContinualLM-main_kv_grad/output_qk_roc_2021_2500',type=str, help="task id")
    # parser.add_argument("--base_dir", default='/home/longjing/zlz/ContinualLM-main/output_qk_0.1_e4_256_L2_epoch', type=str,help="task id")
    #parser.add_argument("--base_dir", default='/home/zlz/.cache/huggingface/transformers',type=str, help="task id")
...
def parseing_finetune():
    ...
    parser.add_argument('--model_name_or_path', type=str, default='/home/zlz/codes/LLMs/ContinualLM-main_kv_grad/roberta-base')
    parser.add_argument('--output_dir', type=str, default=None)
    parser.add_argument('--output_dir_after', type=str, default=None)
    parser.add_argument('--lr', type=float, default=3e-5)
    parser.add_argument('--batch_size', type=int, default=16)
